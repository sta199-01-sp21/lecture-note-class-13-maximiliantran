...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture-note-class-13-maximiliantran/manhattan.csv")
```
...
- Parameter of interest: Mean of price
...
**Interpretation**: % of mice that died while not on treatment is between 0.69 and 0.797.
...
The results show that the likelihood of a mice living while on treatment was between 0.552 and 0.651.
